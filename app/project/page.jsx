...
const projects = [
  {
    ...
    category: 'Full Stack',
    title: 'Quiz App',
    description: 'The quiz app allows users to both create and take quizzes, with a MySQL database handling data storage for quiz questions, user profiles, and results. Using Node.js for the backend ensures smooth data processing and efficient server-side operations. React powers the frontend, delivering an intuitive interface for users to effortlessly design quizzes and participate in them',
    stack: [{name: "MySql"}, {name: "Tailwind Css"}, {name: "React"}, {name: "Nodejs"}],
    image: '/assets/work/thumb1.png',
    live: "",
    github: "https://github.com/AyushbLM10/QuizAppp",
  },
  {
    num: "02",
    category: 'Full Stack',
